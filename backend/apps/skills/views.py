...
class SkillListView(APIView):
    ...
    def get(self, request):
        ...
        return success_response(
            data=serializer.data, message="Skills fetched successfully"
        )
...
class UserSkillView(APIView):
    ...
    def get(self, request):
        ...
        serializer = UserSkillSerializer(
            user_skils, many=True, context={"request": request}
        )

        return success_response(
            data=serializer.data, message="User skills Fetched succesfully"
        )
...
class UserSkillDeleteView(APIView):
    ...
    def delete(self, request, skill_id):
        ...
        return success_response(message="Skill removed succesfully")
...
class MatchFeedview(APIView):
    def get(self, request):
        ...
        return success_response(
            data=serializer.data, message="Matches Fetched successfully"
        )
