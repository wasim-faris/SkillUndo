          ...
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              {session.status === 'confirmed' && session.meeting_link && (
                <div className="rounded-xl border border-[rgba(52,211,153,0.3)] bg-[rgba(52,211,153,0.06)] p-3.5">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 text-white shadow-md hover:shadow-lg hover:scale-[1.03] active:scale-[0.98]"
...
function SessionCard({ session, currentUserId, pendingAction, onAction, onOpenDetail, reviewed }) {
  ...
  return (
    ...
    >
      ...
      {session.status === 'confirmed' && session.meeting_link && (
        <div className="mb-3 flex items-center justify-between gap-2 rounded-xl bg-[rgba(52,211,153,0.06)] border border-[rgba(52,211,153,0.25)] px-3 py-2">
          ...
          <button
            onClick={() => window.open(session.meeting_link, '_blank', 'noopener,noreferrer')}
            className="shrink-0 flex items-center gap-1 px-3 py-1 rounded-lg text-[10px] font-bold text-white transition-all hover:scale-[1.03] active:scale-[0.97] shadow-sm"
            style={{ background: 'linear-gradient(135deg, #34d399 0%, #059669 100%)' }}
          >
